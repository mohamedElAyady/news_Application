...
public class ProcessInBackground_France24 extends AsyncTask<Integer, Void, Exception> {
    ...
    public ProcessInBackground_France24(ArrayList<Articles> listitem, ListView lvRss, SwipeRefreshLayout swipeRefreshLayout) {
    ...
    protected Exception doInBackground(Integer... integers) {
        ...
        try {
            ...
            URL url1 = new URL("https://www.france24.com/ar/اقتصاد/rss");
